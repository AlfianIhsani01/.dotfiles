...
complete -c starship -n "__fish_starship_needs_command" -f -a "config-schema" -d 'Generate a schema for the starship configuration as JSON-schema'
...
complete -c starship -n "__fish_starship_using_subcommand config-schema" -s h -l help -d 'Print help'
complete -c starship -n "__fish_starship_using_subcommand help; and not __fish_seen_subcommand_from bug-report completions config explain init module preset print-config prompt session time timings toggle config-schema help" -f -a "bug-report" -d 'Create a pre-populated GitHub issue with information about your configuration'
complete -c starship -n "__fish_starship_using_subcommand help; and not __fish_seen_subcommand_from bug-report completions config explain init module preset print-config prompt session time timings toggle config-schema help" -f -a "completions" -d 'Generate starship shell completions for your shell to stdout'
complete -c starship -n "__fish_starship_using_subcommand help; and not __fish_seen_subcommand_from bug-report completions config explain init module preset print-config prompt session time timings toggle config-schema help" -f -a "config" -d 'Edit the starship configuration'
complete -c starship -n "__fish_starship_using_subcommand help; and not __fish_seen_subcommand_from bug-report completions config explain init module preset print-config prompt session time timings toggle config-schema help" -f -a "explain" -d 'Explains the currently showing modules'
complete -c starship -n "__fish_starship_using_subcommand help; and not __fish_seen_subcommand_from bug-report completions config explain init module preset print-config prompt session time timings toggle config-schema help" -f -a "init" -d 'Prints the shell function used to execute starship'
complete -c starship -n "__fish_starship_using_subcommand help; and not __fish_seen_subcommand_from bug-report completions config explain init module preset print-config prompt session time timings toggle config-schema help" -f -a "module" -d 'Prints a specific prompt module'
complete -c starship -n "__fish_starship_using_subcommand help; and not __fish_seen_subcommand_from bug-report completions config explain init module preset print-config prompt session time timings toggle config-schema help" -f -a "preset" -d 'Prints a preset config'
complete -c starship -n "__fish_starship_using_subcommand help; and not __fish_seen_subcommand_from bug-report completions config explain init module preset print-config prompt session time timings toggle config-schema help" -f -a "print-config" -d 'Prints the computed starship configuration'
complete -c starship -n "__fish_starship_using_subcommand help; and not __fish_seen_subcommand_from bug-report completions config explain init module preset print-config prompt session time timings toggle config-schema help" -f -a "prompt" -d 'Prints the full starship prompt'
complete -c starship -n "__fish_starship_using_subcommand help; and not __fish_seen_subcommand_from bug-report completions config explain init module preset print-config prompt session time timings toggle config-schema help" -f -a "session" -d 'Generate random session key'
complete -c starship -n "__fish_starship_using_subcommand help; and not __fish_seen_subcommand_from bug-report completions config explain init module preset print-config prompt session time timings toggle config-schema help" -f -a "time" -d 'Prints time in milliseconds'
complete -c starship -n "__fish_starship_using_subcommand help; and not __fish_seen_subcommand_from bug-report completions config explain init module preset print-config prompt session time timings toggle config-schema help" -f -a "timings" -d 'Prints timings of all active modules'
complete -c starship -n "__fish_starship_using_subcommand help; and not __fish_seen_subcommand_from bug-report completions config explain init module preset print-config prompt session time timings toggle config-schema help" -f -a "toggle" -d 'Toggle a given starship module'
complete -c starship -n "__fish_starship_using_subcommand help; and not __fish_seen_subcommand_from bug-report completions config explain init module preset print-config prompt session time timings toggle config-schema help" -f -a "config-schema" -d 'Generate a schema for the starship configuration as JSON-schema'
complete -c starship -n "__fish_starship_using_subcommand help; and not __fish_seen_subcommand_from bug-report completions config explain init module preset print-config prompt session time timings toggle config-schema help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'

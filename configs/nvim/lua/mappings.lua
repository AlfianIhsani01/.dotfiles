...
local function my_on_attach(bufnr)
  ...
  map("n", "<C-i>", api.tree.change_root_to_node, opts("CD"))
  map("n", "<C-e>", api.node.open.replace_tree_buffer, opts("Open: In Place"))
  map("n", "z", api.node.show_info_popup, opts("Info"))
  ...
  map("n", "w", api.fs.rename_basename, opts("Rename: Basename"))
  ...
  map("n", "gy", api.fs.copy.basename, opts("Copy Basename"))
  map("n", "l", api.tree.toggle_hidden_filter, opts("Toggle Filter: Dotfiles"))
  map("n", "L", api.tree.toggle_gitignore_filter, opts("Toggle Filter: Git Ignore"))
  map("n", "I", api.node.navigate.sibling.last, opts("Last Sibling"))
  map("n", "N", api.node.navigate.sibling.first, opts("First Sibling"))
  map("n", "o", api.node.open.toggle_group_empty, opts("Toggle Group Empty"))
  ...
  map("n", "<C-o>", api.node.open.no_window_picker, opts("Open: No Window Picker"))
